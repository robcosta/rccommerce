...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> resourceNotFound(ResourceNotFoundException e, HttpServletRequest request) {
        ...
        CustomError err = new CustomError(Instant.now().truncatedTo(ChronoUnit.SECONDS), status.value(), e.getMessage(), request.getRequestURI());
    ...
    public ResponseEntity<CustomError> methodArgumentNotValid(MethodArgumentNotValidException e,
        ...
        ValidationError err = new ValidationError(Instant.now().truncatedTo(ChronoUnit.SECONDS), status.value(), "Dados inválidos",
